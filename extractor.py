...
class ListExtactor():
   ...
   def creatlistfromtext(self,inputfilename)->list:
      list_of_lists=[]
   ...
   def convertInputFileType(self,inputfilename,outputfilepath):
   ...
   def create_json(self,target_path, target_json_file, json_data):
